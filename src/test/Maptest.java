...
public class Maptest {
	...
	public Maptest(String trainingMaterialPath) {
	...
	public double getCount(String s) {
		...
		double count = 1;
//		while (trainingMaterial_datatable.elements().hasMoreElements()) {
//			System.out.println(trainingMaterial_datatable.elements().nextElement());
//		    if(map.get(s) == null){
//		      map.put(s,1);
//		    }else{
//		      map.put(s,(int)count + 1);
//		    }
//		}
...
//            }
 	...
 	public static void main(String[] args) {
 		String trainingMaterialPath = "Data/words.txt";
 		//
 		Maptest wordCountSet = new Maptest(trainingMaterialPath);
